...
urlpatterns = [
    ...
    path("api/all-lessons", LessonsListAPIView.as_view(), name='accessed-lessons-list'),
    path("api/product-lessons/<int:product_id>", ProductLessonsListAPIView.as_view(), name='product-lessons-list'),
    path('api/statistics', ProductStatisticsAPIView.as_view(), name='statistics'),
]
